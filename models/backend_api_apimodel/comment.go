...
type Comment struct {
	...
	// The author_image_profile_url property
	author_image_profile_url *string
	// The author_uid property
	author_uid *string
	// The author_username property
...
// GetAuthorImageProfileUrl gets the author_image_profile_url property value. The author_image_profile_url property
// returns a *string when successful
func (m *Comment) GetAuthorImageProfileUrl() *string {
	return m.author_image_profile_url
}
...
// GetAuthorUsername gets the author_username property value. The author_username property
// returns a *string when successful
func (m *Comment) GetAuthorUsername() *string {
	return m.author_username
}
...
func (m *Comment) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["author_image_profile_url"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetStringValue()
		if err != nil {
			return err
		}
		if val != nil {
			m.SetAuthorImageProfileUrl(val)
		}
		return nil
	}
	...
	res["author_username"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetStringValue()
		if err != nil {
			return err
		}
		if val != nil {
			m.SetAuthorUsername(val)
		}
		return nil
	}
...
func (m *Comment) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
		err := writer.WriteStringValue("author_image_profile_url", m.GetAuthorImageProfileUrl())
		if err != nil {
			return err
		}
	}
	...
	{
		err := writer.WriteStringValue("author_username", m.GetAuthorUsername())
		if err != nil {
			return err
		}
	}
...
// SetAuthorImageProfileUrl sets the author_image_profile_url property value. The author_image_profile_url property
func (m *Comment) SetAuthorImageProfileUrl(value *string) {
	m.author_image_profile_url = value
}
...
// SetAuthorUsername sets the author_username property value. The author_username property
func (m *Comment) SetAuthorUsername(value *string) {
	m.author_username = value
}
...
type Commentable interface {
	...
	GetAuthorImageProfileUrl() *string
	GetAuthorUid() *string
	...
	GetReplyCount() *int32
	GetUpdatedAt() *string
	SetAuthorImageProfileUrl(value *string)
